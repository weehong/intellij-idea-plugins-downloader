...
1. **Clone the Repository**:
   ```bash
   git clone https://github.com/weehong/intellij-idea-plugins-downloader.git
   cd intellij-idea-plugins-downloader
   ```
...
Follow the on-screen instructions to search for and install your desired plugins.
